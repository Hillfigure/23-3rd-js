...
console.log(person.evaluations[1]);

let emptyArray = [];

emptyArray.push("Green", "Blue", "Red");
console.log(emptyArray);

console.log(emptyArray.length);
console.log(emptyArray[emptyArray.length-1]);
emptyArray.push("Yellow", 5, {greeting: "Hi ik ben een object"});
console.log(emptyArray[emptyArray.length-1]);
...
console.log("Naam kattensoort 3: " + catBreeds[2].food.favourite_food);